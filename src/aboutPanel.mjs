/**
 * About panel webview module (ESM)
 * 
 * Manages the About panel that displays extension information and links.
 */

// Access vscode API via globalThis (injected by the CommonJS wrapper)
const vscode = globalThis.vscode;

// Import createRequire to load JSON files
...
export class AboutPanel {
  ...
  _getHtmlContent() {
    ...
    // Using createRequire to load JSON in ESM context
